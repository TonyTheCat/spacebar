...
Source: `git@github.com:TonyTheCat/page-tools-synth.git`, commit **c0d9204** (tip of `main`,
...
| `vendor/voice-lines.js` | `src/voice-lines.js` | `f7de9ab5929eb0c9bdc5a1c8f601d696d14243eedb3c43ad19f6ce01954c42d1` |
...
hears one sentence while a log says another. NINE lines, nine recordings: `key-refused`,
